<%@ Page Title="Customer Table" Language="VB" MasterPageFile="~/Site.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="CUSTID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="CUSTLASTNAME" HeaderText="Customer Last Name" SortExpression="CUSTLASTNAME" />
            <asp:BoundField DataField="CUSTFIRSTNAME" HeaderText="Customer First Name" SortExpression="CUSTFIRSTNAME" />
            <asp:BoundField DataField="CUSTEMAIL" HeaderText="Customer Email" SortExpression="CUSTEMAIL" />
