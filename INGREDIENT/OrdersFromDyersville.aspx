<%@ Page Title="Orders From Dyersville Store" Language="VB" MasterPageFile="~/Site.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT I.IngredName as &quot;Ingredient Name&quot;, DI.&quot;IngrAmtDemanded&quot; as &quot;Demand of Ingredients&quot;
...
WHERE I.INGREDIENTID=DI.IngredientID"></asp:SqlDataSource>
    ...
    <p style="text-align:left; color:#0B3861;">
        This table shows summed demand for each ingredient at Dyersville store.
    </p>
