<%@ Page Title="Coffee Sold in Lawton Store" Language="VB" MasterPageFile="~/Site.master" %>
...
ORDER BY &quot;Qty Sold&quot; Desc"></asp:SqlDataSource>
    ...
    <p style="text-align:left; color:#0B3861;">
        This table shows the most frequently sold coffee items for the Lawton store.
    </p>
